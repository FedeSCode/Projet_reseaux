...
public class Unsubscriber {
    public static void unSubscriber(BufferedReader userIn, BufferedReader serverResponse , PrintWriter out) {
        String separator = "--------------------------------------------------------------------------------------";
        ...
        try {
            ...
            if (userChoice.equals("1")) {
                ...
                request = new Unsubscribe(null, text);
            ...
            if (userChoice.equals("2")) {
                ...
                text = userIn.readLine();
                request = new Unsubscribe(text, null);
            }
            //wait for messages
            assert request != null;
